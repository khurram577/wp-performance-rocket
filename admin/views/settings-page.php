		...
		<div class="wppr-content">
			<form method="post" action="options.php">
				...
				<div id="tab-dashboard" class="wppr-tab-content active">
					...
					<p>Test your website's performance using Google PageSpeed Insights API. <br/><small><strong>Note:</strong> Google PageSpeed requires a publicly accessible URL. Localhost or private staging sites will fail.</small></p>
					...
					<div class="wppr-speed-test-controls" style="display: flex; gap: 10px; align-items: center; margin-bottom: 20px; flex-wrap: wrap;">
						...
						<button type="button" id="wppr-run-test" class="button button-primary button-hero">Run Speed Test</button>
						<span class="spinner" id="wppr-test-spinner"></span>
					</div>

					<div class="wppr-results" id="wppr-results" style="display: none;">
						<div class="wppr-score-card">
							<h3>Desktop Score</h3>
							<div class="wppr-score-circle" id="score-desktop">--</div>
						</div>
						<div class="wppr-score-card">
							<h3>Mobile Score</h3>
							<div class="wppr-score-circle" id="score-mobile">--</div>
						</div>
					</div>
				</div>
